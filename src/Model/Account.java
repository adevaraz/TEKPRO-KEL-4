...
public class Account {
   ...
   private int role;
   private int transferAccumulate;
   private boolean resetreq;

   // Account constructor initializes attributes
   public Account(int theAccountNumber, int thePIN, boolean theStatus,
      double theAvailableBalance, double theTotalBalance, int theRole, int theTransferAccumulate,
      boolean theResetReq) {
      ...
      role = theRole;
      transferAccumulate = theTransferAccumulate;
      resetreq = theResetReq;
   }
   ...
   public int getAccumulate() {
       return transferAccumulate;
   }
   
   public void setAccumulate(int amount) {
       transferAccumulate += amount;
   }
   
   public boolean getResetReq() {
       return resetreq;
   }
   
   public void setResetReq(boolean newSet) {
       resetreq = newSet;
   }
} 